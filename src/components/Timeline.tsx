...
import { faShieldAlt, faUserShield, faLock } from '@fortawesome/free-solid-svg-icons';
...
const timelineData = [
  {
    ...
    company: 'CSIRT UNY',
    description: 'Security Assesment and Implementing Detection Systems. (me as individual contributor)',
    icon: faShieldAlt,
  },
  {
    date: '2025',
    ...
    company: 'GdpLabs',
    description: 'Developed and Maintained Security Information and Event Management include Security Orchestration, Automation, and Response.',
    icon: faUserShield,
  },
  {
    date: '2021',
    title: 'IT Support',
    company: 'XYZ Computer',
    description: 'Software and Hardware Maintenance.',
    icon: faLock,
  },
];
